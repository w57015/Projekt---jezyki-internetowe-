...
<head>
	...
	<title> Kontakt | Usługi marketingowe - Karpatia Promotion </title>
	...
	<body>
		<!--<div align="center">   NIE DZIALA PRZEZ TO LOGO-->
			<div id="kontener">
				...
				<div id="zawartoscKontakt">
				<div id="DaneKontaktowe">
				
				<h1> Kontakt</h1> <br/> <br/>
				
				<strong><p>Karpatia Promotion</p></strong>
				<p>Agencja reklamowa</p> 
				<p>ul. Wierzbowa 12</p> 
				<p>35-106 Rzeszów</p>
				<p> NIP: 123 456 789</p><br/><br/>
				
				<strong><p> Telefon kontaktowy: </p></strong>
				<p> +48 965 875 142</p>
				<p> +48 589 632 547</p><br/><br/>
				
				<strong><p> Email:</p></strong>
				<p> kontakt@karpatiapromotion.pl</p>
				
				</div>
				<!-- koniec div DaneKontaktowe --> 
				</div>
				<!-- koniec div zawartoscKontakt --> 
					<div id="copyright">
