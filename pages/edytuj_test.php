			...
			<div id="kontener">
				...
				<div id="zawartosc">
                                    <div id="srodkowa_czesc_zawartosci">
                                        ...
                                        <div id="dodaj_pyt">
                                    <form action="index.php?page=dodaj_pytanie" method="post">
                                        
                                        <h1>Dodaj pytanie </h1>
                                        <br>
                                            
                                            <p>Treść pytania:</p><input type="text" name="pytanie"><br>
                                                        <p>Odp a:</p><input type="text" name="odpA"><br>
                                                                <p> Odp b:</p><input type="text" name="odpB"><br>
                                                                        <p>Odp c:</p><input type="text" name="odpC"><br>
                                                                                <p>Odp d:</p><input type="text" name="odpD"><br>
                                                                                <p>Prawidłowa odpowiedź:</p><input type="text" name="odpPr"><br> <br>

                                        <input type="submit" value="Dodaj pytanie"/>

                                    </form>
                                        </div>
                                        <!-- koniec div dodaj pyt -->
                                           
                                        <div id="usun_pyt">
                                    <form action="index.php?page=usun_pytanie" method="post">
                                        
                                        <h1>Usuń pytanie</h1><br>
                                        <p>Numer pytania:</p><input type="text" name="nr_pytania"><br>
